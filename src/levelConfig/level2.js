const map = {
  ...
  blocks: [{
    ...
    funcEnd(e, angle, world) {
      ...
      const time = Math.abs(world.childrenWithId.bridge.rotation.y
				- tmp) * 400;
  ...
  path: {
    ...
    p17: {
      ...
      neighbors: ['p16'],
      onComing() {
        const size = app.world.settings.blockSize;
        if (!app.world.childrenWithId.btn1.hasMove) {
          ...
          new TWEEN.Tween(app.world.childrenWithId.btn1.position)
            ...
            .start()
            .onComplete(() => {
              const cube = app.world.meshFactory.createCube({
                x: -1,
                y: -4.6,
                z: -6,
                sy: 3,
              ...
              const cube2 = app.world.meshFactory.createCube({
                x: -2,
                y: -4.6,
                z: -6,
                sy: 3,
              ...
              const cube3 = app.world.meshFactory.createCube({
                x: 0,
                y: -4.6,
                z: -5,
                sy: 3,
              ...
              const cube4 = app.world.meshFactory.createCube({
                x: 0,
                y: -4.6,
                z: -4,
                sy: 3,
              ...
              const cube5 = app.world.meshFactory.createCube({
                x: 1,
                y: -4.6,
                z: -4,
                sy: 3,
              ...
              const cube6 = app.world.meshFactory.createCube({
                x: 2,
                y: -4.6,
                z: -4,
                sy: 3,
              ...
              const btn2 = app.world.meshFactory.createRoundRect({
                type: 'roundRect',
                id: 'btn2',
                y: -3.5,
                sy: 0.6,
              ...
              new TWEEN.Tween(cube6.position)
                ...
                .start()
                .onComplete(() => {
                  const tri = app.world.meshFactory.createTri({
                    y: 7,
                    x: 5,
                    z: 1,
